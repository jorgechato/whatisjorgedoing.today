    ...
    const statusJSX = () => {
        ...
        return (
            <div className="text-center">
                <span className="cursor-pointer inline-flex items-center rounded-full p-2 bg-accent text-white group transition-all duration-500 focus:outline-none" role="alert" tabindex="0">
